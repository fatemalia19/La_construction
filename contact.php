...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-6 col-xs-7">
                            <div class="logo">
                                    <img src="images/favicon.ico" alt="logo image">La Construcción
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-6 col-xs-5">
                            <nav class="main__menu__nav  hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="#">Media Center</a>
                                        <ul class="dropdown">
                                    ...
                                    <li class="drop"><a href="#">PROJECTS</a>
                                        <ul class="dropdown">
                                            <li><a href="projects-one.html">Completed projects</a></li>
                                            <li><a href="projects-two.html">On going projects</a></li>
                                        </ul>
                                    </li>
                                    <li class="drop"><a href="research&investor.html">Research & Investor</a>
                                    </li>
                            ...
                            <div class="mobile-menu clearfix visible-xs visible-sm">
                                <nav id="mobile_dropdown">
                                    <ul>
                                        ...
                                        <li><a href="research&investor.html">Research & Investor</a>
                                        </li>
                                        <li><a href="contact.php">contact</a></li>
                                    </ul>
                                </nav>
                        ...
                        <div class="htc__address__container">
                            ...
                            <div class="ct__address">
                                ...
                                <div class="ct__details">
                                    <p>House No-69/D/1, Road No-6A<br>Dhanmondi, Dhaka</p>
                                </div>
                            </div>
                            <!-- End Single Address -->
                            <!-- Start Single Address -->
                            <div class="ct__address">
                                ...
                                <div class="ct__details">
                                    <p><a href="#">01712190270</a></p>
                                    <p><a href="#">01822109054</a></p>
                                </div>
                            </div>
                            <!-- End Single Address -->
                        </div>
                                ...
                                <div class="footer quick__link">
                                    ...
                                    <div class="footer__link">
                                        <ul class="ft__menu">
                                            ...
                                            <li><a href="research&investor.html">Research & Investor</a></li>
                                        </ul>
                                        <ul class="ft__menu">
                                            <li><a href="photos.html">Media Center</a></li>
                                            <li><a href="projects-one.html">Projects</a></li>
    ...
    $db = mysqli_connect ('localhost','root','','laconstruction');
    ...
    if(isset($_POST['contact-form'])){
        ...
        $q= "INSERT INTO message (nm ,email , tel, sub, mess) VALUES ('$name','$email','$telephone','$subject','$message' )";
        mysqli_query($db,$q);
